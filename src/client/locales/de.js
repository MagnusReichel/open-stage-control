module.exports = {
    ...
    fragment_mode_explanation: 'Die Sitzung wird als Fragment gespeichert: nur das erste untergeordnete Element von root wird gespeichert.',

    // fullscreen
    fullscreen: 'Vollbild',
    fullscreen_unnavailable: 'Vollbild nicht verfügbar',
    fullscreen_addtohome: 'Sie müssen diese Seite zu Ihrem Startbildschirm hinzufügen, um sie im Vollbildmodus zu starten',

    // inspector
    inspector_error: 'Es ist ein Fehler aufgetreten. Öffne die Konsole, um mehr zu lesen.',
    ...
    remotesave_overwrite: 'Diese Datei existiert bereits, möchtest du sie überschreiben?',
    remotesave_fail: 'Die Datei konnte nicht auf dem Server gespeichert werden, verwende stattdessen "export".',
    remotesave_success: 'Datei erfolgreich gespeichert',
    remotesave_forbidden: 'Speichern auf dem Server nicht möglich, verwende stattdessen "exportieren".',
    ...
    session_unsaved: 'Die Änderungen gehen verloren, wenn du diese Sitzung schließt, ohne zu speichern. Fortfahren?',
    session_oldversion_title: 'Warnung',
    session_oldversion: 'Diese Sitzung wurde mit einer älteren Version dieser Software erstellt - eine automatische Konvertierung wurde durchgeführt. Nach dem Speichern wird diese Sitzung wahrscheinlich nicht korrekt mit älteren Versionen geladen, es wird empfohlen, eine Sicherungskopie davon zu erstellen.',
